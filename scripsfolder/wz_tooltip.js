...
config. BgColor			= '#32CD32'	// Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#8FB64F'
...
config. OffsetX			= -500		// Horizontal offset of left-top corner from mousepointer
config. OffsetY			= -25		// Vertical offset
